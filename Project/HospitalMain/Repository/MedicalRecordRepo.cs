...
namespace Repository
{
    public class MedicalRecordRepo
    {
        ...
        public MedicalRecordRepo(String dbPath)
        {
            ...
            MedicalRecord mr1 = new MedicalRecord("1", "0605994802463", "Pera", "Peric", "4098240", "pera@mail.com", "Partizanska 13, Novi Sad", Gender.Male, new DateTime(1994, 05, 06), BloodType.A_positive, reports, allergens1);
            MedicalRecord mr2 = new MedicalRecord("2", "0808985802463", "Ivan", "Ivic", "4489965", "ivan@mail.com", "Partizanska 14, Novi Sad", Gender.Male, new DateTime(1985, 08, 08), BloodType.O_positive, reports, allergens2);
            MedicalRecord mr3 = new MedicalRecord("3", "1111001802463", "Zika", "Zikic", "41478115", "zika@mail.com", "Partizanska 15, Novi Sad", Gender.Male, new DateTime(2001, 11, 11), BloodType.AB_negative, reports, allergens3);
