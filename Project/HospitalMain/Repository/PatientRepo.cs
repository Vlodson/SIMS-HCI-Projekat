...
namespace Repository
{
   public class PatientRepo
   {
      ...
      public PatientRepo(String dbPath)
      {
            ...
            Patient p2 = new Patient("2", "0808985802463", "Ivan", "Ivic", "0605234548", "ivan@mail.com", "Partizanska 14, Novi Sad", Gender.Male, new DateTime(1985, 08, 08), new MedicalRecord(),  new ObservableCollection<Examination>());
